...
public class AdsController {
    ...
    public ResponseEntity<AdsDto> addAd(
        ...
        return new ResponseEntity<>(adsService.createAd(createAdsDto, imageFile,
                authentication.getDeclaringClass().getName()), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<?> deleteAd(@PathVariable Integer id, Authentication authentication) throws IOException {
        if (adsService.deleteAd(id, authentication.getDeclaringClass().getName())) {
    ...
    public ResponseEntity<AdsDto> updateAd(@PathVariable Integer id,
        ...
        return adsService.updateAd(id, createAdsDto, authentication.getDeclaringClass().getName())
    ...
    public ResponseEntity<ResponseWrapperAdsDto> getAdsMe(Authentication authentication) {
        return ResponseEntity.ok(adsService.getAdsMe(authentication.getDeclaringClass().getName()));
    }
